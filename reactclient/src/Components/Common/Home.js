        ...
        <section className='cta-area d-flex flex-wrap'>
          ...
          <div className='cta-content'>
            ...
            <h6>
              ...
              Integer ut ultricies orci, lobortis egestas sem. Duis non volutpat
              arcu, eu mollis tellus. Sed finibus aliquam neque sit amet sod
              ales. Maecenas sed magna tempor, efficitur maur is in,
              sollicitudin augue. Praesent pretium finibus quam.
            </h6>
            ...
            <div className='row align-items-end'>
              <div className='col-12 col-sm-6 col-lg-3'>
                ...
                >
                  ...
                  <h6>
                    In vitae nisi aliquam, scelerisque leo a, volutpat sem. Viva
                    mus rutrum dui fermentum eros hendrerit.
                  </h6>
                    ...
                    <div className='news-content'>
                      ...
                      <div className='news-meta'>
                        ...
                        <a href='#' className='post-date'>
                          <img src='img/core-img/calendar.png' alt='' /> April
                          26
                        </a>
                      </div>
                    </div>
            ...
            <div className='row justify-content-center'>
              <div className='col-12 col-sm-10 col-lg-8'>
                <div className='nl-content text-center'>
                  ...
                  <p>
                    Curabitur elit turpis, maximus quis ullamcorper sed, maximus
                    eu neque. Cras ultrices erat nec auctor blandit.
                  </p>
                </div>
              </div>
            </div>
